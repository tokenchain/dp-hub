...
func postProposalHandlerFn(cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		coinName := req.Deposit.GetDenomByIndex(0)
		outAmt := req.Deposit.AmountOf(coinName)
		listCoin := sdk.Coins{sdk.NewCoin(coinName, outAmt.RoundInt())}

		msg := gov.NewMsgSubmitProposal(content, listCoin, req.Proposer)
