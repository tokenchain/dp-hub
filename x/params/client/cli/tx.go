...
import (
	...
	//govTypes "github.com/tokenchain/ixo-blockchain/x/gov/types"
	paramscutils "github.com/tokenchain/ixo-blockchain/x/params/client/utils"
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := govTypes.NewMsgSubmitProposal(content, cutils.ParseDecCoinRounded(proposal.Deposit), from)
