...
func NewParamChangeProposalReq(baseReq rest.BaseReq, title, description string, change ParamChangesJSON, proposer sdk.AccAddress, deposit sdk.DecCoins, height uint64) ParamChangeProposalReq {
	return ParamChangeProposalReq{
		baseReq,
		title,
		description,
		change,
...
func NewParamChangeWithSubkey(subspace, key, subkey string, value json.RawMessage) ParamChangeJSON {
	return ParamChangeJSON{
		subspace,
		key,
		subkey,
		value,
