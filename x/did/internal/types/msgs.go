...
var (
	_ types.DpMsg = MsgAddDid{}
	_ types.DpMsg = MsgAddCredential{}
)
...
func (msg MsgAddDid) GetSignerDid() Did { return msg.DidDoc.Did }
...
func (msg MsgAddCredential) GetSignerDid() Did { return msg.DidCredential.Issuer }
