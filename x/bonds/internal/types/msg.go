...
var (
	_ did.IxoMsg = MsgCreateBond{}
	_ did.IxoMsg = MsgEditBond{}
	_ did.IxoMsg = MsgBuy{}
	_ did.IxoMsg = MsgSell{}
	_ did.IxoMsg = MsgSwap{}
	_ did.IxoMsg = MsgMint{}
	_ did.IxoMsg = MsgBurn{}
	_ did.IxoMsg = MsgTransfer{}
)
type (
...
func (msg MsgCreateBond) ValidateBasic() error {
	...
	if !exported.IsValidDid(msg.BondDid) {
		return exported.Invalid(fmt.Sprintf("bond did is invalid. got - %s", msg.BondDid))
	}

	if !exported.IsValidDid(msg.CreatorDid) {
		return exported.Invalid(fmt.Sprintf("creator did is invalid. got - %s", msg.CreatorDid))
	}
...
func (msg MsgEditBond) ValidateBasic() error {
	...
	// Check that DIDs valid
	if !exported.IsValidDid(msg.BondDid) {
		return exported.Invalid("bond did is invalid")
	} else if !exported.IsValidDid(msg.EditorDid) {
		return exported.Invalid("editor did is invalid")
	}
...
func (msg MsgBuy) ValidateBasic() error {
	...
	if !exported.IsValidDid(msg.BondDid) {
		...
		return exported.Invalid("buyer did is invalid")
	}
...
func (msg MsgSell) ValidateBasic() error {
	...
	if !exported.IsValidDid(msg.BondDid) {
		...
		return exported.Invalid("seller did is invalid")
	}
...
func (msg MsgSwap) ValidateBasic() error {
	...
	if !exported.IsValidDid(msg.BondDid) {
		...
		return exported.Invalid("swapper did is invalid")
	}
