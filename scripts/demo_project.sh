...
ixocli tx did add-did-doc "$MIGUEL_DID_FULL"
...
echo "did:dxp:4XJLBfGtWSGKSz4BeRxdun"
ixocli q auth account "ixo1545vwm70g6tws43a3epakzwyhpj7hxcs7qgpcv"
echo "did:dxp:U7GK8p8rVhJMKhBVRCJJ8c"
