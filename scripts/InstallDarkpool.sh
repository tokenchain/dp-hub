...
GOFILENAME="go1.14.4.linux-amd64.tar.gz"
...
mkdir /home/dxo/.dxod
mkdir /home/dxo/.dxod/config

cp /root/genesis/$CHAIN_ID/genesis.json /home/dxo/.ixod/config/genesis.json

chown -R dxo:dxo /home/dxo/.$DAEMONNAME
chown -R dxo:dxo /home/dxo/.$DAEMONNAME/config/
chown -R dxo:dxo /home/dxo/.$DAEMONNAME/config/genesis.json
...
cp /root/genesis/$CHAIN_ID/genesis.json /home/dxo/.dxod/config/genesis.json
