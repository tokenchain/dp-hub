...
func ErrFunctionNotAvailableForFunctionType() error {
	return errors.Wrap(x.ErrFunctionNotAvailableForFunctionType, "Function is not available for the function type.")
}
