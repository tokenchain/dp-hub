...
import (
	...
	"github.com/tokenchain/dp-block/x/bonds"
	...
	"github.com/tokenchain/dp-block/x/nameservice"
	"github.com/tokenchain/dp-block/x/oracles"
	"github.com/tokenchain/dp-block/x/payments"
	"github.com/tokenchain/dp-block/x/project"
	"github.com/tokenchain/dp-block/x/treasury"
	"io"
	"os"
)
...
func NewDarkpoolApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	app.paymentsKeeper = payments.NewKeeper(app.cdc, keys[payments.StoreKey], app.subspaces[payments.ModuleName], app.bankKeeper, app.didKeeper, paymentsReservedIdPrefixes)
	app.projectKeeper = project.NewKeeper(app.cdc, keys[project.StoreKey], app.subspaces[project.ModuleName], app.accountKeeper, app.paymentsKeeper, app.didKeeper)
